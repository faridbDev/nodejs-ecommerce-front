...
const allPrice = [
  ...
  {
    amount: "10000000 - 50000000",
  },
  {
    amount: "50000000 - 100000000",
  }
];
                              ...
                              {colorsLoading ? (
                                ...
                                <RadioGroup onChange={setColor}>
                                  <div className="flex items-start  flex-row flex-wrap">
                                    {colors?.map((color) => (
                                      <RadioGroup.Option key={color?._id} value={color}
                            ...
                            <div className="space-y-6 mt-2">
                              {allPrice?.map((price) => (
                                <div key={Math.random()} className="flex items-center">
                                  <input onClick={() => setPrice(price?.amount)} name="price" type="radio" className="h-4 w-4 rounded border-gray-300 cursor-pointer text-indigo-600 focus:ring-indigo-500"/>
                            ...
                            <div className="space-y-2">
                              {brands?.map((brand) => (
                                <div key={brand?._id} className="flex items-center">
                                  <input onClick={() => setBrand(brand?.name)} name="brand" type="radio" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"/>
                                  <label className="ml-3 min-w-0 flex-1 text-gray-500">
                                    {brand?.name}
                                  </label>
                                </div>
                            ...
                            <div className="space-y-6">
                              {sizeCategories.map((option) => (
                                <div key={option} className="flex items-center">
                                  <input type="radio" name="size" onClick={() => setSize(option)} className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"/>
                                  <label className="ml-3 min-w-0 flex-1 text-gray-500">
                                    {option}
                                  </label>
                                </div>
                        ...
                        <div className="space-y-6">
                          {sizeCategories.map((size) => (
                            <div key={size} className="flex items-center">
                              <input type="radio" name="size" onClick={() => setSize(size)} className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"/>
                              <label className="ml-3 min-w-0 flex-1 text-gray-500">
                                {size}
                              </label>
                            </div>
