                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    ...
                    {products?.map((product) => (
                      <tr key={product._id}>
                        <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                          <div className="flex items-center">
                            <div className="h-10 w-10 flex-shrink-0">
                              ...
                              <img src={`data:${product?.images[0].contentType};base64,${product?.images[0].data.toString("base64")}`} alt={product?.name} className="h-10 w-10 rounded-full"/>
                            </div>
                            <div className="ml-4">
                        ...
                        {/* delete */}
                        <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                          <button  onClick={() => deleteProductHandler(product._id)} className="text-indigo-600 hover:text-indigo-900">
